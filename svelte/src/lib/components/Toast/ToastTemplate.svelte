<script lang="ts">
  ...
  const classByType = {
    ...
    info: 'text-blue-500 bg-blue-100 dark:bg-blue-700 dark:text-blue-200',
...
<div class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
  <div class={`inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-lg ${classByType[type]}`}>
    {#if type === 'success'}
